...
function sendEmail(req, res) {
    ...
    var mailOptions = {
        ...
        html: "Pulsa <a href='http://142.93.240.17/emailConfirm/"+correo+"'>aquí</a> para confirmar tu cuenta, Será un gusto tenerte informad@."
    };
    // Enviamos el email
...
function sendEmailReset1(req, res) {
    ...
    var mailOptions = {
        ...
        "<p> Por favor confirma este correo para saber que eres el propietario <a href='http://142.93.240.17/confirm_email_reset/"+id+"'>aquí</a>  </p>" +
